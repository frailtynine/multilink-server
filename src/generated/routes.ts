...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { GetLinksController } from './../controllers/GetLinksController';
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/get_links',
            ...
            ...(fetchMiddlewares<RequestHandler>(GetLinksController.prototype.getAlbum)),

            async function GetLinksController_getAlbum(request: ExRequest, response: ExResponse, next: any) {
            ...
            try {
                ...
                const controller = new GetLinksController();
